    ...
    return (
        ...
        <div className='px-4'>
            ...
            <div className="h-[816px] pt-24 pb-72 flex flex-col bg-depositions bg-cover bg-center relative">
                ...
                <div className="absolute top-0 bottom-0 left-0 w-44 bg-gradient-to-r from-black/90 to-transparent z-10"></div>
                <div className="absolute top-0 bottom-0 right-0 w-44 bg-gradient-to-r from-transparent to-black/90 z-10"></div>
